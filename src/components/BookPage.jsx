...
const BookPage = forwardRef(({ image, text, imageStyle, noPadding }, ref) => {
  return (
    <div
      ref={ref}
      className={`bg-[#f5efe3] w-full h-full border border-[#c7b299] ${noPadding ? "" : "p-6 rounded-2xl shadow-lg"}`}
    >
